...
packs <- c("abind", "agricolae", "agridat", "agriTutorial", 
           ...
           "getPass", "GGally", "ggalt", "ggeffects", "ggfittext", "ggforce", 
           "ggformula", "ggfortify", "ggmosaic", "ggplot2", "ggplotify", 
           "ggpmisc", "ggpp", "ggpubr", "ggraph", "ggrepel", "ggridges", 
           "ggsci", "ggside", "ggsignif", "ggstats", "ggtext", "ggthemes", 
           "ggwordcloud", "gh", "gitcreds", "gld", "glmnet", "GlobalOptions", 
           "globals", "glue", "gmp", "gnm", "goftest", "gower", "graphlayouts", 
           "gridExtra", "gridGraphics", "gridtext", "gt", "gtable", "gtExtras", 
           "gtools", "hardhat", "haven", "heplots", "here", "hexbin", "HH", 
           "highr", "HistData", "Hmisc", "hms", "htmlTable", "htmltools", 
           "htmlwidgets", "httpuv", "httr", "httr2", "hydroGOF", "hydroTSM", 
           "hypergeo", "igraph", "imputeTS", "infer", "ini", "inline", "insight", 
           "interp", "inum", "ipred", "ISLR", "isoband", "iterators", "janeaustenr", 
           "janitor", "jomo", "jpeg", "jquerylib", "jsonlite", "juicyjuice", 
           "Kendall", "KernSmooth", "keyring", "knitr", "labeling", "labelled", 
           "Lahman", "later", "lattice", "latticeExtra", "lava", "lazyeval", 
           "leaps", "lemon", "libcoin", "lifecycle", "listenv", "litedown", 
           "lme4", "lmerTest", "lmodel2", "lmom", "lmomco", "Lmoments", 
           "lmtest", "loo", "lubridate", "magrittr", "mapdata", "mapproj", 
           "maps", "markdown", "MASS", "Matrix", "MatrixModels", "matrixStats", 
           "mc2d", "memoise", "metR", "mgcv", "mice", "miceadds", "microbenchmark", 
           "mime", "miniUI", "minqa", "minty", "mitml", "mitools", "MKdescr", 
           "MKinfer", "mlbench", "modeldata", "ModelMetrics", "modelr", 
           "modeltools", "moderndive", "mosaic", "mosaicCore", "mosaicData", 
           "multcomp", "multcompView", "munsell", "mvtnorm", "nanonext", 
           "ncdf4.helpers", "ncdf4", "nlme", "nloptr", "nnet", "nortest", 
           "numDeriv", "nycflights13", "openair", "openssl", "openxlsx", 
           "operator.tools", "ordinal", "osqp", "paletteer", "pan", "parallelly", 
           "parameters", "partykit", "patchwork", "pbapply", "pbkrtest", 
           "pbs", "PCICt", "performance", "permute", "pillar", "pingr", 
           "pkgbuild", "pkgconfig", "pkgdown", "pkgload", "PlackettLuce", 
           "plogr", "plotly", "plotrix", "pls", "plyr", "png", "polyclip", 
           "polynom", "posterior", "praise", "prediction", "prettyunits", 
           "primes", "prismatic", "pROC", "processx", "prodlim", "productplots", 
           "profvis", "progress", "progressr", "proj4", "promises", "proxy", 
           "ps", "psychotools", "psychotree", "purrr", "qap", "quadprog", 
           ...
           "Rmpfr", "RMySQL", "robustbase", "rootSolve", "roxygen2", "rpart", 
           "rpivotTable", "rprojroot", "rrefine", "RSpectra", "RSQLite", 
           "rstan", "rstanarm", "rstantools", "rstatix", "rstudioapi", "rtf", 
           "Rttf2pt1", "rversions", "rvest", "rworldmap", "rworldxtra", 
           "s2", "sandwich", "sass", "scales", "scatterplot3d", "scs", "SearchTrees", 
           "segmented", "selectr", "seriation", "sessioninfo", "sf", "shades", 
           "shape", "shiny", "shinyFiles", "shinyjs", "shinystan", "shinythemes", 
           ...
           "tidygraph", "tidyr", "tidyselect", "tidytext", "timechange", 
           "timeDate", "tinytex", "TLMoments", "tokenizers", "treemapify", 
           "trend", "tryCatchLog", "tseries", "TSP", "TTR", "tweenr", "tzdb", 
           "ucminf", "units", "urca", "urlchecker", "usethis", "utf8", "V8", 
           "vars", "vcd", "vcdExtra", "vctrs", "vegan", "verification", 
           "viridis", "viridisLite", "visdat", "visreg", "vroom", "waffle", 
           "wakefield", "waldo", "weathermetrics", "Weighted.Desc.Stat", 
           "weights", "whisker", "withr", "wk", "wordcloud", "writexl", 
...
versions <- c("1.4-8", "1.3-7", "1.24", "0.1.5", "1.2.1.2", "2.8.235", 
              "1.14-4", "1.1.9", "1.0-15", "1.2.1", "0.2.1", "1.5.0", "0.1-3", 
              "0.9.12-4.7", "1.12.0", "0.15.2", "1.87.0-1", "0.3.1", "4.6.0", 
              ...
              "0.4.16", "0.2-6", "0.5-1", "7.3-23", "0.4-11", "3.6.5", "3.2-5", 
              "0.8.0", "0.7.3", "0.3-66", "2.1.8.1", "3.5.2", "1.4.1", "1.2.9", 
              "0.19-4.1", "0.2-20", "1.4-3", "2.1.1", "2.3.4", "2.1-1", "1.3.0", 
              ...
              "1.40", "1.10", "2.4.5", "1.6.5", "0.3.6", "0.6.37", "1.2-2", 
              "0.5.0", "4.6.26", "1.2", "0.4.4", "1.1.4", "0.8.0", "0.33", 
              "1.23-1", "1.1.1.6", "1.7-16", "2.0.3", "0.5.5", "1.0.0", "0.5.0", 
              "0.3.2", "1.4-0", "1.11.0", "3.1.0", "1.5.1", "1.0.3", "1.16", 
              ...
              "1.5.2", "8.24.0", "0.8-90", "0.2.1", "1.7.1", "1.2-5", "1.5-3", 
              "1.6.6", "1.11.3", "1.40.0", "1.0.0", "1.3.3", "2.0.1", "3.0.1", 
              "0.1.3", "1.1.14.1", "0.1.5", "1.5-20", "2.1.5", "0.2-4", "2.2.1", 
              "0.4.0", "2.2.1", "0.10.2", "0.4.2", "0.12.0", "0.4.17", "0.3.3", 
              "3.5.2", "0.1.2", "0.6.1", "0.5.8-1", "0.6.0", "2.2.1", "0.9.6", 
              "0.5.6", "3.2.0", "0.3.1", "0.6.4", "0.9.0", "0.1.2", "5.1.0", 
              "0.6.2", "1.4.1", "0.1.2", "2.6.7", "4.1-8", "0.1.2", "0.17.0", 
              "1.8.0", "0.7-5", "1.1-5", "1.2-3", "1.0.2", "1.2.2", "2.3", 
              "0.5-1", "0.1.5", "1.0.0", "0.3.6", "0.5.0", "3.9.5", "1.4.1", 
              "2.5.4", "1.7.4", "1.0.1", "1.28.5", "3.1-53", "0.11", "0.9-3", 
              "5.2-3", "1.1.3", "2.4.3", "0.5.8.1", "1.6.4", "1.6.16", "1.4.7", 
              "1.1.2", "0.6-0.1", "0.7-0.1", "1.2-14", "2.1.4", "3.3", "1.0.8", 
              "0.3.1", "0.3.21", "1.2.0", "1.1-6", "1.0-5", "0.9-15", "1.4", 
              "0.2.7", "1.0.14", "1.0.0", "2.2.1", "2.7-6", "0.1-11", "0.1.4", 
              "2.0.0", "0.1.0", "2.2.1", "2.23-26", "1.3.2", "1.50", "0.4.3", 
              "2.14.0", "12.0-0", "1.4.2", "0.22-7", "0.6-30", "1.8.1", "0.2.2", 
              "3.2", "0.5.0", "1.0-10", "1.0.4", "0.9.1", "0.7", "1.1-37", 
              "3.1-3", "1.7-4", "3.2", "2.5.1", "1.3-1", "0.9-40", "2.8.0", 
              "1.9.4", "2.0.3", "2.3.1", "1.2.11", "3.4.2.1", "2.0", "7.3-65", 
              "1.7-3", "0.5-4", "1.5.0", "0.2.1", "2.0.1", "0.18.0", "1.9-3", 
              "3.17.0", "3.17-44", "1.5.0", "0.13", "0.1.2", "1.2.8", "0.0.5", 
              "0.4-5", "2.4", "0.8", "1.2", "2.1-6", "1.4.0", "1.2.2.2", "0.1.11", 
              "0.2-23", "0.7.0", "1.9.1", "0.9.4.0", "0.20.4", "1.4-28", "0.1-10", 
              "0.5.1", "1.3-3", "1.5.2", "0.3-7", "1.24", "3.1-168", "2.2.1", 
              "7.3-20", "1.0-4", "2016.8-1.1", "1.0.2", "2.18-2", "2.3.2", 
              "4.2.8", "1.6.3", "2023.12-4.1", "0.6.3.3", "1.6.0", "1.9", "1.43.0", 
              "0.24.2", "1.2-23", "1.3.0", "1.7-2", "0.5.3", "1.1", "0.5-4.4", 
              "0.13.0", "0.9-7", "1.10.2", "2.0.5", "1.4.7", "2.0.3", "2.1.1", 
              "1.4.0", "0.4.3", "0.2.0", "4.10.4", "3.8-4", "2.8-5", "1.8.9", 
              "0.1-8", "1.10-7", "1.4-1", "1.6.1", "1.0.0", "0.3.18", "1.2.0", 
              "1.6.1", "1.1.2", "1.18.5", "3.8.6", "2024.06.25", "0.1.1", "0.4.0", 
              "1.2.3", "0.15.1", "1.0-15", "1.3.2", "0.4-27", "1.9.1", "0.7-4", 
              "0.16-1", "1.0.4", "0.1-2", "1.5-8", "0.4.27", "6.1", "0.8.0", 
              "1.7.0", "1.0.4", "0.16.0", "1.8.2", "1.27.0", "2.13.0", "2.6.1", 
              "1.4.0", "0.1", "0.3.3", "3.6-32", "0.51.6", "2.3", "1.4.0", 
              "1.1-3", "2.0.1", "1.0.14", "14.4.2-1", "0.3.4.0.2", "5.1.10", 
              "0.3.1", "1.98-1.17", "2.6.4", "0.4.4", "0.6.1", "2.3.2", "2.1.5", 
              "1.4.5", "1.3.0", "0.4.0", "0.5-1", "1.0-5", "2.0.0", "2.1.2", 
              "2.5.0", "1.1.7", "0.8.9", "1.4.4", "1.3.18", "1.2.3", "1.12.1", 
              "1.1.6", "2.29", "1.3.9.3", "1.0-0", "0.11.1", "0.99-4-1", "1.8.2.4", 
              "7.3.2", "4.1.24", "0.3.0", "2.0.4", "2.1.0", "0.16-2", "2.3.9", 
              "2.32.7", "2.32.1", "2.4.0", "0.7.2", "0.17.1", "0.4-14.1", "1.3.12", 
              "2.1.2", "1.0.4", "1.3-8", "1.01", "1.1.7", "3.1-1", "0.4.10", 
              "1.4.0", "0.3-44", "3.2.7", "0.5.5", "2.1-4", "0.4-2", "1.5.7", 
              "1.2.3", "1.0-20", "1.4.0", "1.4.6.1", "1.10.0", "0.9.3", "2.1.0", 
              "2.6.0", "1.2.0", "0.9.0", "1.2.0", "2.8.10", "2.8.17", "0.19.0", 
              "2.1.5", "0.11.1", "0.7.1", "1.4.0", "0.1.7-1", "2.2-0", "2.11-1", 
              "1.84-2", "0.3.3", "1.8.1", "0.5.4", "1.3-5", "2021.1", "2.32.10", 
              "0.2.3", "0.3.2", "0.3.0", "1.5", "0.9.15", "1.8.7", "1.5.1", 
              "1.5-4", "1.10.3", "3.8-3", "2.1.3", "3.4.3", "1.2.2", "0.36.2.1", 
              "1.8-42", "3.2.3", "2.4.9", "1.0.0", "1.1-3", "0.3.4", "3.2.1", 
              "1.3.1", "1.3.1", "1.2.1", "0.4.2", "0.3.0", "4041.110", "0.57", 
              "0.7.5.3", "0.3.0", "2.5.6", "1.1.6", "1.3.1", "0.10-58", "1.2-4", 
              "0.24.4", "2.0.3", "0.5.0", "1.2.2", "0.8-7", "1.3-4", "1.0.1", 
              "3.1.0", "1.2.4", "6.0.3", "1.6-1", "1.4-13", "0.8-5", "0.6.5", 
              "2.6-10", "1.44", "0.6.5", "0.4.2", "0.6.0", "2.7.0", "1.6.5", 
              "1.0.2", "0.3.6", "0.6.1", "1.2.2", "1.0", "1.0.4", "0.4.1", 
              "3.0.2", "0.9.4", "2.6", "1.5.4", "0.52", "3.99-0.18", "1.3.8", 
              "1.0.1", "1.8-4", "0.14.1", "2.3.10", "0.2.0", "2.3.2", "1.8-14", 
              "0.2.1", "0.11-1",
              # mmtable2 package from GitHub added manually to list
              # aida-package package from GitHub added manually to list
              # CDT package from GitHub added manually to list
