...
Public Class dlgInventoryPlot
    ...
    Private Sub cmdOptions_Click(sender As Object, e As EventArgs) Handles cmdOptions.Click
        ...
        sdgInventoryGraph.SetRCode(clsInventoryPlots:=clsInventoryPlot, bReset:=bResetSubdialog)
